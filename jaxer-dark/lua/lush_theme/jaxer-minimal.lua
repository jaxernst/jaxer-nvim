...
local theme = lush(function(injected_functions)
	...
	return {
		...
		-- MoreMsg        { }, -- |more-prompt|
		NonText({ fg = green }), -- '@' at the end of the window, characters from 'showbreak' and other characters that do not really exist in the text (e.g., ">" displayed when a double-wide character doesn't fit at the end of the line). See also |hl-EndOfBuffer|.
